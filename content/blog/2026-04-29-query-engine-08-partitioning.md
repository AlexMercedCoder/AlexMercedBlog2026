...
![Hash, range, and list partitioning strategies showing how the same data is distributed differently](/assets/blog/query-engine/08-partitioning-partition-types.png)
...
![Partition pruning showing 5 of 6 monthly partitions skipped when filtering by March](/assets/blog/query-engine/08-partitioning-partition-pruning.png)
...
![The data skew problem showing one partition with 10x more data creating a straggler node](/assets/blog/query-engine/08-partitioning-data-skew-problem.png)
