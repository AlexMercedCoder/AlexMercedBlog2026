...
![Papercut five-part buyer scorecard wheel for agentic analytics](./diagram-1.png)
...
![Papercut comparison of simple demo chatbot versus production analytics agent architecture](./diagram-2.png)
...
![Papercut open lakehouse evaluation model for agentic analytics with governance, semantics, federation, observability, cost, and action safety](./diagram-3.png)
