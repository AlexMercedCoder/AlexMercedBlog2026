...
This is Part 8 of a 15-part [Apache Iceberg Masterclass](../README.md). [Part 7](/blog/2026-04-29-iceberg-masterclass-07-lakehouse-catalogs.html) covered the traditional catalog landscape. This article examines a newer approach: embedding the catalog directly inside the storage layer.
...
![Standalone catalogs versus embedded catalogs showing how the architecture simplifies](/assets/blog/iceberg-masterclass/08-embedded-catalogs-embedded-vs-standalone.png)
...
![S3 Tables architecture showing the built-in Iceberg catalog with automatic compaction](/assets/blog/iceberg-masterclass/08-embedded-catalogs-s3-tables-architecture.png)
...
**Built-in maintenance:** S3 Tables runs automatic compaction in the background, merging small files into optimally-sized ones without any user configuration. It also handles snapshot expiry and orphan file cleanup. This eliminates one of the biggest operational burdens of Iceberg (covered in [Part 10](/blog/2026-04-29-iceberg-masterclass-10-maintaining-iceberg.html)).
...
![Decision tree for choosing between embedded and standalone catalogs](/assets/blog/iceberg-masterclass/08-embedded-catalogs-embedded-decision-tree.png)
...
[Part 9](/blog/2026-04-29-iceberg-masterclass-09-storage-degradation.html) covers how table storage degrades over time and why maintenance matters regardless of which catalog you use.
