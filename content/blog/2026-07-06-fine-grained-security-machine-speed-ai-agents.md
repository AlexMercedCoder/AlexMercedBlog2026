...
![Papercut agent identity flowing through MCP, policy, query engine, catalog, and lakehouse data](./diagram-1.png)
...
![Papercut fine-grained policy checks for row, column, metric, and tool access](./diagram-2.png)
...
![Papercut audited AI agent loop inside governed lakehouse architecture](./diagram-3.png)
