...
tags:
  ...
  - Polaris
cover_image: >-
  /assets/images/2026/apache-lakehouse/02-apache-parquet/parquet-dictionary-encoding.png
draft: false
---
...
![Diagram showing Row-Based vs Column-Based physical storage on disk](./row-vs-columnar-storage.png)
...
![Diagram of Dictionary Encoding mapping text strings to small integer identifiers](./parquet-dictionary-encoding.png)
...
![Diagram of Predicate Pushdown showing the engine skipping a row group based on min/max stats](./parquet-predicate-pushdown.png)
