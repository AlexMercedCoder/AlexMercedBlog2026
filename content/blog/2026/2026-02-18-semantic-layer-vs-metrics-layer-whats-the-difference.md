...
tags:
  ...
  - BI
cover_image: >-
  /assets/images/2026/semantic_layer_seo/03-semantic-layer-vs-metrics-layer/metrics-subset.png
draft: false
---
![Semantic layer vs metrics layer — the metrics layer is a subset](/assets/images/2026/semantic_layer_seo/03-semantic-layer-vs-metrics-layer/semantic-vs-metrics.png)
...
![The metrics layer as a subset within the broader semantic layer](/assets/images/2026/semantic_layer_seo/03-semantic-layer-vs-metrics-layer/metrics-subset.png)
...
![Choosing between a metrics layer and a full semantic layer](/assets/images/2026/semantic_layer_seo/03-semantic-layer-vs-metrics-layer/when-to-choose.png)
