...
date: '2026-03-05'
description: >-
  Windsurf is an AI-native code editor built as a fork of VS Code. Its standout
  feature is Cascade, an agentic AI system that plans and executes multi-step
  coding...
author: Alex Merced
tags:
  - AI
  - Developer Tools
  - Coding
cover_image: /assets/images/2026/aitoolblogs/windsurf/four-integration-approaches.png
draft: false
---
...
![Windsurf AI editor with Cascade agent connecting to Dremio Agentic Lakehouse via MCP](/assets/images/2026/aitoolblogs/windsurf/windsurf-dremio-architecture.png)
...
![Four approaches to connecting AI coding tools to Dremio](/assets/images/2026/aitoolblogs/windsurf/four-integration-approaches.png)
