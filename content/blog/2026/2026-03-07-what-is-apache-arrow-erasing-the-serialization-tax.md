...
tags:
  ...
  - Arrow
  - Polaris
cover_image: /assets/images/2026/apache-lakehouse/05-apache-arrow/arrow-flight-rpc.png
draft: false
---
...
![Diagram showing the serialization tax burning CPU cycles while translating data between languages](./serialization-tax.png)
...
![Zero-Copy architecture showing two different languages pointing to the exact same memory buffer](./zero-copy-arrow.png)
...
![Arrow Flight RPC versus traditional REST/ODBC protocols over a network](./arrow-flight-rpc.png)
