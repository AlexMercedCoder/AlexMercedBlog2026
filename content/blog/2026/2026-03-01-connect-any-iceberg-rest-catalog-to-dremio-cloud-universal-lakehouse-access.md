...
date: '2026-03-01'
description: >-
  The Apache Iceberg REST Catalog specification defines a standard HTTP API for
  managing Iceberg table metadata. Any catalog implementation that conforms to
  this...
author: Alex Merced
tags:
  - Dremio
