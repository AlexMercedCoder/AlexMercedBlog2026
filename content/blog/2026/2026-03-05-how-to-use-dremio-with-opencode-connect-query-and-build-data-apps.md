...
date: '2026-03-05'
description: >-
  OpenCode is an open-source, terminal-based AI coding agent released under the
  MIT license. It provides a TUI with split panes, uses the Language Server
  Protocol...
author: Alex Merced
tags:
  - AI
  - Developer Tools
  - Coding
cover_image: /assets/images/2026/aitoolblogs/opencode/four-integration-approaches.png
draft: false
---
...
![OpenCode TUI connecting to Dremio Agentic Lakehouse via MCP](/assets/images/2026/aitoolblogs/opencode/opencode-dremio-architecture.png)
...
![Four approaches to connecting AI coding tools to Dremio](/assets/images/2026/aitoolblogs/opencode/four-integration-approaches.png)
