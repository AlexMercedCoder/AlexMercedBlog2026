...
tags:
  ...
  - Polaris
cover_image: >-
  /assets/images/2026/apache-lakehouse/03-apache-iceberg/iceberg-metadata-tree.png
draft: false
---
...
![The Iceberg Metadata Tree showing the path from Catalog down to Data Files](./iceberg-metadata-tree.png)
...
![Diagram showing Schema Evolution mapping unique column IDs to file structures over time](./iceberg-schema-evolution.png)
...
![Diagram showing Time Travel snapshots pointing an overlapping set of underlying Parquet files](./iceberg-time-travel.png)
