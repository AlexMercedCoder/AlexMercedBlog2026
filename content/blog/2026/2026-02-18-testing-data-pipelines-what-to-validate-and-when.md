...
tags:
  ...
  - Best Practices
  - Pipelines
cover_image: /assets/images/2026/debp/08-testing-data-pipelines/regression-testing.png
draft: false
---
![Data pipeline testing pyramid with schema tests at the base, contract tests in the middle, and regression tests at the top](/assets/images/2026/debp/08-testing-data-pipelines/testing-pyramid.png)
...
![Schema test examples: column existence, type validation, null checks, uniqueness checks](/assets/images/2026/debp/08-testing-data-pipelines/schema-tests.png)
...
![Regression testing: comparing aggregates, distributions, and trends over time](/assets/images/2026/debp/08-testing-data-pipelines/regression-testing.png)
