...
tags:
  ...
  - Polaris
cover_image: >-
  /assets/images/2026/apache-lakehouse/01-apache-software-foundation/apache-lakehouse-umbrella.png
draft: false
---
*Read the complete Open Source and the Lakehouse series:*
* [Part 1: Apache Software Foundation](/blog/2026-03-07-apache-software-foundation-history-purpose-and-process.html)
...
![The Apache Incubation Process flow showing Podling, Mentorship, IP Clearance, and Graduation to TLP](./asf-incubation-process.png)
...
![Comparison Diagram of ASF versus Linux Foundation showing individual vs corporate membership](./asf-vs-lf-comparison.png)
...
![Three layers of the Apache Lakehouse stacked under the ASF Umbrella showing Parquet, Iceberg, and Arrow](./apache-lakehouse-umbrella.png)
