...
tags:
  ...
  - Best Practices
  - Pipelines
cover_image: /assets/images/2026/debp/04-idempotent-pipelines/idempotent-antipatterns.png
draft: false
---
...
![Merge pattern: staging records matched against target by business key, updating or inserting](/assets/images/2026/debp/04-idempotent-pipelines/merge-pattern.png)
...
![Anti-patterns: blind append creating duplicates, timestamp-based keys, deferred dedup](idempotency-antipatterns.png)
