...
tags:
  ...
  - Polaris
cover_image: >-
  /assets/images/2026/apache-lakehouse/04-apache-polaris/polaris-credential-vending.png
draft: false
---
*Read the complete Open Source and the Lakehouse series:*
* [Part 1: Apache Software Foundation: History, Purpose, and Process](/blog/2026-03-07-apache-software-foundation-history-purpose-and-process.html)
* [Part 2: What is Apache Parquet?](/blog/2026-03-07-what-is-apache-parquet-columns-encoding-and-performance.html)
* [Part 3: What is Apache Iceberg?](/blog/2026-03-07-what-is-apache-iceberg-the-table-format-revolution.html)
* [Part 4: What is Apache Polaris?](/blog/2026-03-07-what-is-apache-polaris-unifying-the-iceberg-ecosystem.html)
* [Part 5: What is Apache Arrow?](/blog/2026-03-07-what-is-apache-arrow-erasing-the-serialization-tax.html)
* [Part 6: Assembling the Apache Lakehouse](/blog/2026-03-07-assembling-the-apache-lakehouse-the-modular-architecture.html)
* [Part 7: Agentic Analytics on the Apache Lakehouse](/blog/2026-03-07-agentic-analytics-on-the-apache-lakehouse.html)
...
![Diagram showing multiple query engines connecting to Apache Polaris via REST API, pointing to S3 storage](./polaris-rest-api.png)
...
![Credential vending flow showing Engine, Polaris RBAC check, temporal token, and S3 access](./polaris-credential-vending.png)
...
![Diagram showing Apache Polaris serving as the neutral governing body spanning different clouds and engines](./polaris-neutral-catalog.png)
