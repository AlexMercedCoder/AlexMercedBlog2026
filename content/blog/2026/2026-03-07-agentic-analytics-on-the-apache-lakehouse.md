...
tags:
  ...
  - Arrow
  - Polaris
cover_image: /assets/images/2026/apache-lakehouse/07-agentic-analytics/ai-sql-functions.png
draft: false
---
...
![The Semantic layer translating raw Iceberg datasets into AI-ready business context](./semantic-layer-translation.png)
...
![Autonomous Reflections lifecycle showing query monitoring, background creation, and query acceleration](./autonomous-reflections.png)
...
![AI SQL Function executing inside a Dremio query against Parquet data](./ai-sql-functions.png)
