...
This is Part 13 of a 15-part [Apache Iceberg Masterclass](../README.md). [Part 12](/blog/2026-04-29-iceberg-masterclass-12-python-and-mpp.html) covered Python and MPP engines. This article covers the three primary approaches to streaming data into Iceberg tables and the operational trade-offs each creates.

Iceberg was designed for batch analytics, but most production data arrives continuously. Streaming ingestion bridges this gap by committing data to Iceberg tables at regular intervals. The challenge is that frequent commits create the [small file problem](/blog/2026-04-29-iceberg-masterclass-09-storage-degradation.html), and managing that trade-off between data freshness and table health is the central concern of streaming to Iceberg.

## Table of Contents

1. [What Are Table Formats and Why Were They Needed?](/blog/2026-04-29-iceberg-masterclass-01-table-formats.html)
2. [The Metadata Structure of Current Table Formats](/blog/2026-04-29-iceberg-masterclass-02-metadata-structures.html)
3. [Performance and Apache Iceberg's Metadata](/blog/2026-04-29-iceberg-masterclass-03-iceberg-metadata-performance.html)
4. [Technical Deep Dive on Partition Evolution](/blog/2026-04-29-iceberg-masterclass-04-partition-evolution.html)
5. [Technical Deep Dive on Hidden Partitioning](/blog/2026-04-29-iceberg-masterclass-05-hidden-partitioning.html)
6. [Writing to an Apache Iceberg Table](/blog/2026-04-29-iceberg-masterclass-06-writing-to-iceberg.html)
7. [What Are Lakehouse Catalogs?](/blog/2026-04-29-iceberg-masterclass-07-lakehouse-catalogs.html)
8. [Embedded Catalogs: S3 Tables and MinIO AI Stor](/blog/2026-04-29-iceberg-masterclass-08-embedded-catalogs.html)
9. [How Iceberg Table Storage Degrades Over Time](/blog/2026-04-29-iceberg-masterclass-09-storage-degradation.html)
10. [Maintaining Apache Iceberg Tables](/blog/2026-04-29-iceberg-masterclass-10-maintaining-iceberg.html)
11. [Apache Iceberg Metadata Tables](/blog/2026-04-29-iceberg-masterclass-11-metadata-tables.html)
12. [Using Iceberg with Python and MPP Engines](/blog/2026-04-29-iceberg-masterclass-12-python-and-mpp.html)
13. [Streaming Data into Apache Iceberg Tables](/blog/2026-04-29-iceberg-masterclass-13-streaming-to-iceberg.html)
14. [Hands-On with Iceberg Using Dremio Cloud](/blog/2026-04-29-iceberg-masterclass-14-hands-on-dremio-cloud.html)
15. [Migrating to Apache Iceberg](/blog/2026-04-29-iceberg-masterclass-15-migrating-to-iceberg.html)

## Three Streaming Architectures

![Three approaches to streaming data into Iceberg: Spark, Flink, and Kafka Connect](/assets/blog/iceberg-masterclass/13-streaming-to-iceberg-streaming-approaches.png)
...
**Partitioned writes:** Flink can route events to partitions dynamically based on partition transforms. Combined with Iceberg's [hidden partitioning](/blog/2026-04-29-iceberg-masterclass-05-hidden-partitioning.html), this means streaming data lands in the correct partition directory automatically without any special logic in the streaming application.
...
![Why streaming creates small files and how compaction fixes them in a continuous cycle](/assets/blog/iceberg-masterclass/13-streaming-to-iceberg-streaming-compaction-cycle.png)

Every streaming approach shares the same fundamental problem: frequent commits produce small files. The solution is to pair streaming ingestion with aggressive [compaction](/blog/2026-04-29-iceberg-masterclass-10-maintaining-iceberg.html).
...
[Dremio's automatic table optimization](https://www.dremio.com/blog/table-optimization-in-dremio/) handles this compaction automatically for tables managed by Open Catalog. AWS [S3 Tables](/blog/2026-04-29-iceberg-masterclass-08-embedded-catalogs.html) also provides built-in compaction for streaming workloads.

## The Latency vs. Maintenance Trade-off

![The spectrum from real-time to batch showing how latency affects small file production](/assets/blog/iceberg-masterclass/13-streaming-to-iceberg-latency-vs-maintenance.png)
...
4. **Monitoring** ([metadata tables](/blog/2026-04-29-iceberg-masterclass-11-metadata-tables.html)): Tracks file counts, sizes, and commit frequency
...
After deploying a streaming pipeline, monitor these metrics daily using [metadata tables](/blog/2026-04-29-iceberg-masterclass-11-metadata-tables.html):
...
[Part 14](/blog/2026-04-29-iceberg-masterclass-14-hands-on-dremio-cloud.html) provides a hands-on walkthrough of Iceberg on Dremio Cloud.
