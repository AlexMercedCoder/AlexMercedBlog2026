...
This is Part 3 of a 10-part series on query engine design. [Part 2](/blog/2026-04-29-query-engine-02-row-vs-column-storage.html) covered row vs. column storage layouts. This article goes one level deeper: how data is physically structured within files, and what metadata accompanies it to make reads efficient.
...
![The write speed vs read efficiency spectrum showing heap files, LSM trees, B-trees, and sorted files](/assets/blog/query-engine/03-data-organization-on-disk-write-read-spectrum.png)
...
![Anatomy of a Parquet file showing row groups, column chunks, pages, and the footer with schema and statistics](/assets/blog/query-engine/03-data-organization-on-disk-parquet-file-anatomy.png)
...
![How min/max statistics allow the engine to skip irrelevant row groups when filtering by price](/assets/blog/query-engine/03-data-organization-on-disk-predicate-pushdown-min-max.png)
...
- [Open Source Lakehouse: Architecting Analytical Systems](https://www.amazon.com/Open-Source-Lakehouse-Architecting-Analytical/dp/B0GW595MVL/) by Alex Merced\n\n## Series Table of Contents\n\n1. [How Query Engines Think: The Tradeoffs Behind Every Data System](/blog/2026-04-29-query-engine-01-overview.html)\n2. [Row vs. Column: How Storage Layout Shapes Everything](/blog/2026-04-29-query-engine-02-row-vs-column-storage.html)\n3. [How Databases Organize Data on Disk: Pages, Blocks, and File Formats](/blog/2026-04-29-query-engine-03-data-organization-on-disk.html)\n4. [B-Trees, LSM Trees, and the Indexing Tradeoff Spectrum](/blog/2026-04-29-query-engine-04-indexing-strategies.html)\n5. [Inside the Query Optimizer: How Engines Pick a Plan](/blog/2026-04-29-query-engine-05-query-optimizer.html)\n6. [Volcano, Vectorized, Compiled: How Engines Execute Your Query](/blog/2026-04-29-query-engine-06-execution-models.html)\n7. [Buffer Pools, Caches, and the Memory Hierarchy](/blog/2026-04-29-query-engine-07-memory-and-caching.html)\n8. [Partitioning, Sharding, and Data Distribution Strategies](/blog/2026-04-29-query-engine-08-partitioning.html)\n9. [Hash, Sort-Merge, Broadcast: How Distributed Joins Work](/blog/2026-04-29-query-engine-09-distributed-joins.html)\n10. [Concurrency, Isolation, and MVCC: How Engines Handle Contention](/blog/2026-04-29-query-engine-10-concurrency-control.html)\n\n---\n\n