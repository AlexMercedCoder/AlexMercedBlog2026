...
This is Part 3 of a 15-part [Apache Iceberg Masterclass](../README.md). [Part 2](/blog/2026-04-29-iceberg-masterclass-02-metadata-structures.html) covered the metadata structures of all five table formats. This article focuses on exactly how query engines use Iceberg's metadata to avoid reading data they don't need.
...
![Iceberg scan planning cascade showing how metadata progressively eliminates files at each stage](/assets/blog/iceberg-masterclass/03-iceberg-metadata-performance-scan-planning-cascade.png)
...
![Three layers of data skipping showing partition pruning, file pruning, and the final result](/assets/blog/iceberg-masterclass/03-iceberg-metadata-performance-pruning-example.png)
...
![Per-file statistics tracked in Iceberg manifest entries](/assets/blog/iceberg-masterclass/03-iceberg-metadata-performance-per-file-statistics.png)
...
2. **Consider partition evolution** (covered in [Part 4](/blog/2026-04-29-iceberg-masterclass-04-partition-evolution.html)) to add a partition transform on the column.
