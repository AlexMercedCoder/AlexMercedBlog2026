...
This is Part 2 of a 15-part [Apache Iceberg Masterclass](../README.md). [Part 1](/blog/2026-04-29-iceberg-masterclass-01-table-formats.html) covered why table formats exist. This article breaks down exactly how each format organizes its metadata.
...
![Iceberg's three-layer metadata architecture from catalog to metadata.json to manifest list to manifest files to data files](/assets/blog/iceberg-masterclass/02-metadata-structures-iceberg-metadata-tree.png)
...
![Delta Lake's transaction log structure with JSON commits, Parquet checkpoints, and the reader process](/assets/blog/iceberg-masterclass/02-metadata-structures-delta-lake-transaction-log.png)
...
![Five approaches to table metadata from file-based to database-backed](/assets/blog/iceberg-masterclass/02-metadata-structures-metadata-architecture-comparison.png)
...
[Part 3](/blog/2026-04-29-iceberg-masterclass-03-iceberg-metadata-performance.html) covers how query engines use Iceberg's metadata specifically for performance optimization.
