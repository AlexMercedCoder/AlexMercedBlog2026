...
This is Part 10 of a 10-part series on query engine design. [Part 9](/blog/2026-04-29-query-engine-09-distributed-joins.html) covered distributed joins. This final article covers how engines handle the inevitable conflict when multiple users read and write the same data simultaneously.
...
![Two-Phase Locking versus MVCC showing how locking blocks readers while MVCC allows concurrent access](/assets/blog/query-engine/10-concurrency-control-locking-vs-mvcc.png)
...
![MVCC version chain showing three versions of the same row with different transactions seeing different versions](/assets/blog/query-engine/10-concurrency-control-mvcc-version-chain.png)
...
![Isolation level spectrum from Read Uncommitted (weakest, fastest) to Serializable (strongest, slowest)](/assets/blog/query-engine/10-concurrency-control-isolation-levels.png)
