...
This is Part 14 of a 15-part [Apache Iceberg Masterclass](../README.md). [Part 13](/blog/2026-04-29-iceberg-masterclass-13-streaming-to-iceberg.html) covered streaming approaches. This article is a practical walkthrough of working with Iceberg on [Dremio Cloud](https://www.dremio.com/get-started/), covering table creation, data ingestion, optimization, semantic layer construction, and AI-powered analytics.
...
![From zero to Iceberg in six steps on Dremio Cloud](/assets/blog/iceberg-masterclass/14-hands-on-dremio-cloud-dremio-iceberg-workflow.png)
...
This creates a table with [hidden partitioning](/blog/2026-04-29-iceberg-masterclass-05-hidden-partitioning.html) by day. Users query on `order_date` naturally; the engine handles partition pruning automatically.
...
![Dremio Cloud features for Iceberg including Open Catalog, federation, semantic layer, and AI](/assets/blog/iceberg-masterclass/14-hands-on-dremio-cloud-dremio-platform-features.png)
...
This eliminates the need to move all data into Iceberg before you can query it. You can [start with federation and migrate incrementally](https://www.dremio.com/blog/the-journey-from-scattered-data-to-an-apache-iceberg-lakehouse-with-governed-agentic-analytics/). Federation is especially useful during [migration](/blog/2026-04-29-iceberg-masterclass-15-migrating-to-iceberg.html): query legacy systems and Iceberg tables side by side, then swap the underlying source when you are ready.

## Essential SQL Operations

![Four essential Iceberg SQL operations on Dremio: CREATE, COPY INTO, OPTIMIZE, and time travel](/assets/blog/iceberg-masterclass/14-hands-on-dremio-cloud-dremio-sql-examples.png)
...
[Part 15](/blog/2026-04-29-iceberg-masterclass-15-migrating-to-iceberg.html) covers strategies for migrating existing data into Iceberg.
