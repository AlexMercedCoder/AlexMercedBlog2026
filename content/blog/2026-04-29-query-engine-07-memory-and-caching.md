...
This is Part 7 of a 10-part series on query engine design. [Part 6](/blog/2026-04-29-query-engine-06-execution-models.html) covered execution models. This article covers how engines manage their most precious resource: memory.
...
![Cache hit versus cache miss latency showing the 1000x gap between RAM and SSD access](/assets/blog/query-engine/07-memory-and-caching-cache-hit-miss-latency.png)
...
![Buffer pool architecture showing shared memory pages, page table, cache hits, and background writes to disk](/assets/blog/query-engine/07-memory-and-caching-buffer-pool-architecture.png)
...
![How engines divide available memory between data cache, sort buffers, hash tables, and network buffers](/assets/blog/query-engine/07-memory-and-caching-memory-budget-allocation.png)
